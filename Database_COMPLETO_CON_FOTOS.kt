...
/*
 * VERSION CON CATEGORIAS Y FOTOS - VERSION 7
 * Campos nuevos en ProductEntity:
 *   - photoUri: String?
 *   - photoTimestamp: Long?
 *   - isPhotoUserSelected: Boolean
 */
...
data class ProductEntity(
    ...
    val notes: String,
    val orderIndex: Int,
    // CAMPOS DE FOTO - NUEVOS EN VERSION 7
...
interface ProductDao {
    ...
    @Query("SELECT * FROM products WHERE shoppingListId = :listId ORDER BY categoryId ASC, order
